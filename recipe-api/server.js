...
//For some reason, the API key check does not work, as such I console log it
...
app.get("/info", (req, res) => {
  res.json({
    message: "This is a simple Recipe API. Use the correct API key to access the data.",
  });
});
